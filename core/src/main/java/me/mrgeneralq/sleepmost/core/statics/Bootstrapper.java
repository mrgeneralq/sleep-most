...
import me.mrgeneralq.sleepmost.core.mappers.ConfigMessageMapper;
import me.mrgeneralq.sleepmost.core.providers.GameRuleProvider;
import me.mrgeneralq.sleepmost.core.repositories.*;
import me.mrgeneralq.sleepmost.core.services.*;
...
public class Bootstrapper {
    ...
    public void initialize(Sleepmost main, PluginManager pluginManager){
        ...
        this.gameRuleService = GameRuleProvider.get();
        ...
        this.sleepMostWorldService = new SleepMostWorldService( this.gameRuleService ,new SleepMostWorldRepository());
    ...
    public IGameRuleService getGameRuleService() {
